...
#Function to get start of GDD period, in DOY
doy_first_GDD <- function(temp, base_temp = 10, doy_max = 100) {
...
get_GDD_score <- function(data, base_temp = 10){
  data <- data %>%
...
#AIO function call for GDD method
