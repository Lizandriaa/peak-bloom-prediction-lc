...
doy_prediction_warming <- function(roll_temp, WDD, warming) {
  doy_initial_warming(roll_temp) + which.max(cumsum(pmax(WDD[(doy_initial_warming(roll_temp) + 1):365], 0, na.rm = TRUE)) > warming)
}
