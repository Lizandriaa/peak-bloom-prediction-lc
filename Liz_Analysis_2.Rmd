...
predict_warming <- function(data){
  ...
  data <- data %>%
  mutate(pred_bloom_doy_warming = map(data, ~ doy_prediction_warming(.$WDD, .$tmax, mean_warming))) %>% 
...
doy26_pred_warming_kyoto <- doy26_prediction_warming(all_data, "kyoto", AccuWeather2026_warming)
doy26_pred_warming_liestal <- doy26_prediction_warming(all_data, "liestal", AccuWeather2026_warming)
doy26_pred_warming_newyorkcity <- doy26_prediction_warming(all_data, "newyorkcity", AccuWeather2026_warming)
doy26_pred_warming_vancouver <- doy26_prediction_warming(all_data, "vancouver", AccuWeather2026_warming)
doy26_pred_warming_washingtondc <- doy26_prediction_warming(all_data, "washingtondc", AccuWeather2026_warming)
...
Predictions_2026 <- data.frame(
  Location <- location,
  quetelet_pred_bloom_doy <- pred_bloom_doy_quetelet,
  warming_pred_bloom_doy <- pred_bloom_doy_warming
)
```
